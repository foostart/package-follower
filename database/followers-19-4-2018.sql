...
CREATE TABLE `followers` (
  ...
  `follower_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `follower_overview` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `follower_description` text CHARACTER SET utf8,
  `follower_slug` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `follower_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `follower_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `followers` (`follower_id`, `user_id`, `user_email`, `user_full_name`, `category_id`, `follower_name`, `follower_overview`, `follower_description`, `follower_slug`, `follower_image`, `follower_files`, `follower_status`, `created_at`, `updated_at`) VALUES
